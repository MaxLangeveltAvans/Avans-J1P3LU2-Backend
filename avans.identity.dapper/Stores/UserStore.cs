...
namespace Avans.Identity.Dapper
{
        ...
        where TRoleClaim : IdentityRoleClaim<TKey>, new()
    {
        ...
        /// <summary>
        /// 
        /// TODO: implement property (notably GetUsers -> UsersTable icw async)
        /// </summary>
        public override IQueryable<TUser> Users => GetUsers();
        ...
        /// <inheritdoc/>
        public IQueryable<TUser> GetUsers(/*CancellationToken cancellationToken*/)
        {
            //cancellationToken.ThrowIfCancellationRequested();
            //ThrowIfDisposed();
            var task = UsersTable.GetUsersAsync();
