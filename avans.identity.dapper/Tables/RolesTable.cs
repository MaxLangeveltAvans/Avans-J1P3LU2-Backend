...
namespace Avans.Identity.Dapper
{
        ...
        where TRoleClaim : IdentityRoleClaim<TKey>, new()
    {
        ...
        public virtual async Task<bool> CreateAsync(TRole role) {
            const string sql = @$"
                INSERT INTO {SchemaName}.AspNetRoles
            ...
            using (var transaction = DbConnection.BeginTransaction()) {
                ...
                if (claims?.Count() > 0) {
                    const string deleteClaimsSql = @$"
                        DELETE
                        FROM {SchemaName}.AspNetRoleClaims
                        WHERE RoleId = @RoleId;
                    ";
                    ...
                    const string insertClaimsSql = @$"
                        INSERT INTO {SchemaName}.AspNetRoleClaims (RoleId, ClaimType, ClaimValue)
